"""Ben Au's SG Job Market Insights dashboard — salary distributions & heatmaps."""
...
# Page config
# --------------------------------------------------
st.set_page_config(page_title="Job Market Insights — Ben Au", page_icon="📈", layout="wide")
st.title("Singapore Job Market Insights")
st.caption("Detail distributions (sampled) + Heatmap (DB-aggregated)")

# --------------------------------------------------
# Config
# --------------------------------------------------
DB_PATH = str(Path(__file__).parent.parent.parent / "data" / "raw" / "SGJobData.db")
T_BASE = "jobs_base"
